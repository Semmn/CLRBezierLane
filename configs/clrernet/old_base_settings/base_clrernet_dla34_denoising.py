model = dict(
    ...
    bbox_head=dict(
        type="CLRDenoiseAnchorHead",
        anchor_generator=dict(
            type="AnchorNoiseGenerator",
            num_priors=192,
            num_points=72,
        ),
        img_w=800,
        ...
        # compared to loss_bbox, denoising are in normalized scale and initiali standard deviation is also very small.
        # so the loss_weight for this is set to 1.0
        loss_denoise=dict(type='SmoothL1Loss', reduction='none', loss_weight=1.0),
