model = dict(
    ...
    neck=dict(
        ...
        out_channels=128, # (must be divisible by num_attn_heads * 4)
        num_outs=3,
        attn_num_heads=8,
        attn_window_size=7,
        attn_window_dilation=1,
        attn_ssm_dtrank=32, # default as "auto" -> out_channels // 16
        attn_ssm_dstate=4, # default as 1
        attn_ssm_ratio=1,
        attn_ssm_drop=0.0, # default as 0.0
