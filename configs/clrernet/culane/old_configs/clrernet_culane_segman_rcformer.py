...
_base_ = [
    "../base_clrernet_segman_rcformer.py",
...
cfg_name = "clrernet_culane_segman_rcformer.py"
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(type='AdamW', lr=3e-4), # instead of default 6e-4, use 3e-4 (half of learning rate)
