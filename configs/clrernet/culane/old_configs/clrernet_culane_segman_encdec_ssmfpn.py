...
_base_ = [
    "../base_clrernet_segman_encdec_ssmfpn.py",
...
cfg_name = "clrernet_culane_segman_encdec_ssmfpn.py"
...
optim_wrapper = dict(
    ...
    optimizer=dict(type='AdamW', lr=3e-4), # instead of 6e-4, learning rate is now halved
    # paramwise_cfg=dict(
    #     custom_keys={
