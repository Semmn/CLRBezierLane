...
_base_ = [
    "../base_clrernet_segman_encdec_rcformer.py",
...
cfg_name = "clrernet_culane_segman_encdec_rcformer.py"
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(type='AdamW', lr=3e-4), # default 6e-4, but to stabilize the training of SegMAN Small backbone, we half the learning rate
